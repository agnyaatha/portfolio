      ...
      <div className="about-right">
        ...
        <ul className="about-details">
          ...
          <li key={2}>
            ...
            through HTML5 and CSS3. Sass library is used to enhance the styling
            structure and code readability.Open source SunEditor library is
            being used a RichTextEditor to take notes.
          </li>
          <li key={3}>
          ...
          <li key={4}>
            <b>Functionalities</b> - Creating a new user, adding new user to the
            database, login, logout, creating new note and saving it to the
            database along with the user relationships have been implemented so
            far. There is scope for improvement which has been planned for the
            near future.
          </li>
        </ul>
        {/* </p> */}
